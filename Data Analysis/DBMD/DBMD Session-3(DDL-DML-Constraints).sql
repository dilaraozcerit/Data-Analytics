...
UPDATE Person.Person SET Person_LastName = (SELECT Person_LastName FROM Person.Person_2 WHERE SSN = 889623212886) WHERE SSN = 889623212886
...
ALTER TABLE Book.Author ADD CONSTRAINT pk_author PRIMARY KEY (Authot_Id) --bu çalýþmayacak. nullable primary key olamaz.
