-- Answer the following SQL questions according to SampleSales database


-- 1) Select the annual amount of product produced according to brands
...
-- 2) Select the store which has the most sales quantity in 2018
...
-- 3) Select the store which has the most sales amount in 2018
...
-- 4) Select the personnel which has the most sales amount in 2018
